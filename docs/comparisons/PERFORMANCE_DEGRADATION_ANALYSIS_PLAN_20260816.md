...
> **STATUS: STOPPED / ABANDONED。** P0 首轮证据已完成并停止；本文列出的
> P1/P2、future mechanism queue 和未执行 follow-up 均已废弃。本文仅保留历史
> 设计与边界，不是当前实验流、launch 或 authorization 入口。
