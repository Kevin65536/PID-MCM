...
| --- | --- | --- |
| Main method | frozen E0–R negative evidence → SSM reconstruction reliability → failed instantaneous/interchangeable continuous construct → LC-SPVQ lag probe and synthetic gates → B0/M1/N1 development-only generation → separate independent-holdout protocol before any formal claim | [`SSM_RECONSTRUCTION_RELIABILITY_PLAN.md`](analysis/SSM_RECONSTRUCTION_RELIABILITY_PLAN.md), [`CONTINUOUS_SHARED_PRIVATE_LATENT_PLAN.md`](analysis/CONTINUOUS_SHARED_PRIVATE_LATENT_PLAN.md), [`LC_SPVQ_DEVELOPMENT_PLAN.md`](analysis/LC_SPVQ_DEVELOPMENT_PLAN.md), [`LC-SPVQ smoke record`](analysis/20260820_LC_SPVQ_IMPLEMENTATION_AND_SMOKE.md) |
...
| --- | --- | --- | --- | --- |
| Main method | [`SSM reliability`](analysis/SSM_RECONSTRUCTION_RELIABILITY_PLAN.md) → [`continuous latent`](analysis/CONTINUOUS_SHARED_PRIVATE_LATENT_PLAN.md) → [`LC-SPVQ development`](analysis/LC_SPVQ_DEVELOPMENT_PLAN.md) | The old no-VQ construct remains rejected at 2/16 cells. The new exploratory generation has completed the 12-cell existing-export lag probe, local/causal core, independent K16 VQ, known-lag/null gates, B0/M1/N1 two-task measured smoke, and coupling/q0-q1 QC; none is a scientific endpoint | Add fit-selection-only lag-loss/checkpoint selection before deciding whether to authorize multi-seed/full-epoch development; keep protected cohorts closed | [`PROJECT_STATUS.md#主方法`](PROJECT_STATUS.md#主方法), [`continuous results`](analysis/20260819_CONTINUOUS_SHARED_PRIVATE_LATENT_RESULTS.md), [`LC-SPVQ plan`](analysis/LC_SPVQ_DEVELOPMENT_PLAN.md), [`implementation/smoke record`](analysis/20260820_LC_SPVQ_IMPLEMENTATION_AND_SMOKE.md) |
