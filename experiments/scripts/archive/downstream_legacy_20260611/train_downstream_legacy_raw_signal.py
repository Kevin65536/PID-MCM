...
from src.compatibility.pre_physiology_semantic_20260701.classifiers.multi_lead import MultiLeadClassifier, DualModalityMultiLeadClassifier
...
def create_model(config: dict, device: torch.device) -> nn.Module:
    ...
    if use_raw:
        ...
        from src.compatibility.pre_physiology_semantic_20260701.classifiers.multi_lead import RawMultiLeadClassifier, RawDualModalityClassifier
