...
def initialize_suite(suite_dir: Path) -> Dict[str, Any]:
    ...
    for gpu, seed in enumerate((20260625, 20260626)):
        cognitive_queues[gpu].extend([
            ...
            f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/finalize_tokenizer_next_stage_suite.py --suite-dir {q(suite_dir)} --write-cognitive-configs",
    ...
    audit_commands = [
        ...
        f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/run_tokenizer_next_stage_audits.py --suite-dir {q(suite_dir)} --device cuda:0",
    ]
