...
BASE_CONFIG = project_root / (
    "experiments/configs/archive/pre_physiology_semantic_20260701/source_observation/croce_local/"
...
def training_command(config: Path, run_name: str, smoke: bool) -> str:
    ...
    return (
        f"bash experiments/scripts/archive/pre_physiology_semantic_20260701/launch_legacy_training_nohup.sh --task source-observation-tokenizer "
...
def audit_commands(
    ...
    *,
    ...
    commands = [
        f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/export_coupling_audit_data.py --checkpoint {q(checkpoint)} "
        f"--output-dir {q(export_dir)} --label {q(label)} --device {q(device)}",
        f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/analyze_coupling_identifiability.py --export-dir {q(export_dir)} "
    ...
    if frozen:
        commands.append(
            f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/fit_frozen_coupling_models.py --export-dir {q(export_dir)} "
...
def intervention_commands(suite_dir: Path, suite_name: str, seed: int, device: str) -> list[str]:
    ...
    commands.append(
        f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/prepare_f6_intervention_config.py "
...
def initialize_suite(suite_dir: Path) -> Dict[str, Any]:
    ...
    manifest = {
        ...
        "commands": {
            "export": "experiments/scripts/archive/pre_physiology_semantic_20260701/export_coupling_audit_data.py",
            "position_information_audit": "experiments/scripts/archive/pre_physiology_semantic_20260701/analyze_coupling_identifiability.py",
            "frozen_model_comparison": "experiments/scripts/archive/pre_physiology_semantic_20260701/fit_frozen_coupling_models.py",
            "tokenizer_training": "experiments/scripts/archive/pre_physiology_semantic_20260701/launch_legacy_training_nohup.sh --task source-observation-tokenizer",
            "finalization": "experiments/scripts/archive/pre_physiology_semantic_20260701/finalize_coupling_identifiability_suite.py",
        },
    }
