...
def audit_commands(suite_dir: Path, device: str) -> list[str]:
    ...
    commands.append(f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/finalize_tokenizer_lightweight_alignment_suite.py --suite-dir {q(suite_dir)}")
    return commands
