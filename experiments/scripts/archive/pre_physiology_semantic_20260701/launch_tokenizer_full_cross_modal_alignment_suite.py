...
def audit_commands(suite_dir: Path, run_names: list[str], device: str = "cuda:0") -> list[str]:
    ...
    commands.append(
        f".venv/bin/python experiments/scripts/archive/pre_physiology_semantic_20260701/finalize_tokenizer_full_cross_modal_alignment_suite.py --suite-dir {q(suite_dir)}"
    )
    return commands
