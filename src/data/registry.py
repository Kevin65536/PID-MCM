...
REGISTERED_DATASETS: Dict[str, DatasetRegistration] = {
    ...
    'eeg_fnirs_single_trial': DatasetRegistration(
        ...
        notes=(
            ...
            'Task EEG is released with ocular artifacts; single_trial_eeg_artifact_clean_v3 is the admitted default after controlled-artifact and circular-shift-sham validation.',
        ),
        ...
        default_eeg_signal_branch='single_trial_eeg_artifact_clean_v3',
        eeg_artifact_status='artifact_clean_v3_admitted',
    ),
