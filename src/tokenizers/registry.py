...
def _build_tokenizer_kwargs(tokenizer_type: str, config: Dict[str, Any]) -> Dict[str, Any]:
    ...
    if tokenizer_type in ['patch_vqvae', 'time_patch_vqvae']:
        ...
        return {
            ...
            'assignment_alignment_weight': align_cfg.get('assignment_weight', 0.0),
            'hard_assignment_alignment_weight': align_cfg.get('hard_assignment_weight', 0.0),
            'shared_entropy_weight': align_cfg.get('shared_entropy_weight', 0.0),
            'private_entropy_weight': align_cfg.get('private_entropy_weight', 0.0),
            'shared_eeg_recon_weight': align_cfg.get('shared_eeg_recon_weight', 0.0),
            'shared_fnirs_recon_weight': align_cfg.get('shared_fnirs_recon_weight', 0.0),
            'shared_eeg_common_weight': align_cfg.get('shared_eeg_common_weight', 0.0),
            'shared_fnirs_common_weight': align_cfg.get('shared_fnirs_common_weight', 0.0),
            'eeg_private_residual_weight': align_cfg.get('eeg_private_residual_weight', 0.0),
            'fnirs_private_residual_weight': align_cfg.get('fnirs_private_residual_weight', 0.0),
